                ...
                "details": [
                    {
                        "key": "booking_demand",
                        "name": "Booking Demand",
                        "logic": "Estimate booking demand from the number of unavailable nights.",
                        "formula": "booking_demand = 365 - availability_365",
                    },
                    {
                        "key": "availability_category",
                        "name": "Availability Category",
                        "logic": "Split listings into Low Availability, Medium Availability, and High Availability groups based on available nights.",
                    ...
                    {
                        "key": "availability_efficiency",
                        "name": "Availability Efficiency",
                        "logic": "Evaluate how effectively available nights are used based on price and availability_365.",
                        "formula": "availability_efficiency = price * (365 - availability_365)",
                    },
                    {
                        "key": "revenue_per_available_night",
                        "name": "Revenue per Available Night",
                        "logic": "Evaluate revenue generated per available night when price and availability are linked.",
